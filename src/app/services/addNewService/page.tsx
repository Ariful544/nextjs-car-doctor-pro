  ...
  return (
    <div>
      ...
      <form className="w-full space-y-8 min-h-[600px] md:mt-[130px] md:p-20 p-10 rounded-lg mt-[60px] bg-[#F3F3F3]">
        ...
        <div className="grid md:grid-cols-2 grid-cols-1 gap-6">
          <Input type="number" placeholder="Text here" />
          <Input type="email" placeholder="Service Type" />
        </div>
        <Textarea placeholder="Product Description" />
        <Button className="w-full h-[50px] text-xl font-semibold bg-[#FF3811] hover:bg-[#fd3f35] text-white hover:text-white" variant="outline">Submit</Button>
      </form>
    </div>
  );
}
